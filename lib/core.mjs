...
export async function moveGoal({ space: ref, blockId, toBlockId } = {}) {
  ...
  // the motion changes how a goal is counted, never where it lives: a target
  // in another space would leave this one holding an absorbed tracker's
  // empty shell, and the goal would speak from somewhere the person did not put it
