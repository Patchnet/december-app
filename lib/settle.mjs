...
- Extract numbers. Yearly goals get yearly targets and period "year". Reminders that imply a date get when (YYYY-MM-DD); ones that recur ("every month") also get repeat (daily|weekly|monthly|yearly). A capture's hint names the space the person was viewing: strongly prefer it.
...
const agent = { proc: null, turns: 0, waiting: null, stderrTail: '' }
