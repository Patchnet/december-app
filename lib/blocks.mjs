...
// Ids cross-reference everything (findBlock scans every space), so a collision
// silently wires two things together. Seven base36 chars of Math.random was
// ~36 bits; eight crypto bytes is 64, and the old short ids coexist fine.
export const uid = () => randomBytes(8).toString('base64url')
