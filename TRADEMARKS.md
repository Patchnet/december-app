...
You may say that your software is based on December, or that it works with
December, when that is true.

You may not:

- use December as the name of a fork, product, company, or domain in a way
  that suggests it is the official December project
